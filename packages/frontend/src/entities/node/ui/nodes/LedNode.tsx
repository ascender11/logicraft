...
export const LedNode = ({ data, selected }: NodeComponentProps) => {
  return (
    <BaseLogicNode
      selected={selected}
      handles={[
      ...
      <svg
        ...
        <path
          ...
          style={{ fill: data.outputValue ? 'var(--color-node-accent)' : 'white' }}
        />
        <path
        ...
        />
        <path
          d='M20 35.2707C21.9286 40.2694 22.9948 40.9285 24.8485 35.2707C26.6792 40.2037 27.7973 40.4657 30 35.2707C31.8446 39.8629 32.9319 40.1667 35 35.2707C36.2855 40.3248 37.5016 39.4049 40 35.2707'
          fill='none'
        />
